      ...
      questions: [
        {
          ...
          a: `Residential systems typically range from ${formatPrice(5000)}-${formatPrice(12000)} depending on size and components. The average home needs a 3-6kW system. We offer free consultations to provide accurate quotes based on your specific needs and energy usage.`
        },
        {
        ...
        },
        {
          ...
          a: `Most homeowners see payback in 6-10 years through energy savings and incentives. After that, you enjoy free electricity for the remaining 15-20+ years of the system's life. Total 25-year savings often exceed ${formatPrice(20000)}.`
        }
      ]
    },
    {
